...
const AestheticianCard = ({ action }: { action?: boolean }) => {
  return (
    <Card className="py-0 group overflow-hidden border-none bg-white shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-1 h-full flex flex-col">
      <CardContent className="p-0 flex flex-col h-full">
        ...
        <div className="p-4 space-y-3">
          ...
          <div className="text-center">
            <h3 className="font-semibold text-gray-900 text-lg">Sarah Chen</h3>
