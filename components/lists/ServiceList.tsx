  ...
  return (
    <main className="bg-[#fffcf9]">
      ...
      <div className="flex justify-center flex-col w-full mx-auto">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-5 gap-2 sm:gap-3 md:gap-4 mt-10 sm:max-w-7xl mx-auto px-2 sm:px-4">
          {isLoading && !data
